...
export default function NewForYour() {
  return (
    <section className="container mx-auto px-2 md:px-0 font-inter">
      <section className="overflow-hidden bg-gray-50 sm:grid sm:grid-cols-2">
        <div
          style={{
            paddingLeft: '0px',
          }}
          className="p-8 md:p-12 lg:px-16 lg:py-16"
        >
          <div className="mx-auto max-w-xl text-center sm:text-left">
            <h2 className="text-3xl font-bold text-left text-gray-900 md:text-4xl">
              Is this for you?
            </h2>
            <div className="text-gray-500 md:mt-4 md:block text-justify space-y-3">
              <p>
